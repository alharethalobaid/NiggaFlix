...
export default function Nav() {
  return (
    <nav class="flex justify-between bg-red-500 from-primary to-accent text-white p-5 gap-3">
      <ul class="flex gap-3">

        <li class="px-5 whitespace-nowrap font-semibold text-xl">
          <A href="/">
            NiggaFlix
          </A>
        </li>
      ...
      <li>
        ...
        <li>
          <label class="pl-5 swap swap-rotate">
            <input type="checkbox" checked={true} class="theme-controller" value={_dark} />
            <svg
